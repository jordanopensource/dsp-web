    ...
    <div class="flex flex-row flex-nowrap md:flex-nowrap flex-grow">
      ...
      <div class="ltr:ml-4 rtl:mr-4 flex-grow">
        ...
        <div class="my-2 flex flex-row">
          <span
            class="ltr:mr-2 rtl:ml-2 ltr:sm:mr-4 rtl:sm:ml-4 flex flex-nowrap items-center"
          >
            <template v-if="openSource">
              ...
              ></i>
              <span
                class="hidden sm:inline text-sm mx-1 align-middle"
                v-show="!viewGrid"
                >{{ $t("openSource") }}</span
              >
            </template>
            <template v-else>
              ...
              ></i>
              <span
                class="hidden sm:inline text-sm mx-1 align-middle display-faded"
                v-show="!viewGrid"
                >{{ $t("closedSource") }}</span
              >
            </template>
      ...
      <div
        ...
        :class="
          viewGrid
            ? 'hidden'
            : 'hidden md:flex md:flex-col md:flex-wrap md:justify-end md:min-w-max md:w-48'
        "
      >
